    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children:  [
            widget.fromTrx ? Expanded(child: Text(widget.text,style: interRegularDefault.copyWith(overflow: TextOverflow.ellipsis,color: widget.isFilterBtn ? MyColor.colorBlack : MyColor.colorBlack))): Expanded(child: Text(widget.text,style: interRegularDefault.copyWith(color:MyColor.colorBlack,overflow: TextOverflow.ellipsis),)),
