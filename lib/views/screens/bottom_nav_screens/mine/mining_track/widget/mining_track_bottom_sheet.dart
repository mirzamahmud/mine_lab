            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            DefaultText(text: controller.miningTrackList[index].planDetails?.title ?? "", textColor: MyColor.colorBlack)
                          ],
                        ),
                      ),
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: Dimensions.space5),
                            DefaultText(text: DateConverter.isoStringToLocalDateOnly(controller.miningTrackList[index].createdAt ?? ""), textColor: MyColor.colorBlack)
                          ],
                        ),
                      )
                    ],
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: Dimensions.space5),
                            DefaultText(text: "${MyConverter.twoDecimalPlaceFixedWithoutRounding(controller.miningTrackList[index].amount ?? "")} ${controller.currency}", textColor: MyColor.colorBlack)
                          ],
                        ),
                      ),
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: Dimensions.space5),
                            DefaultText(text: controller.miningTrackList[index].planDetails?.miner ?? "", textColor: MyColor.colorBlack)
                          ],
                        ),
                      )
                    ],
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: Dimensions.space5),
                            DefaultText(text: controller.miningTrackList[index].planDetails?.speed ?? "", textColor: MyColor.colorBlack)
                          ],
                        ),
                      ),
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: Dimensions.space5),
                            DefaultText(
                                text: MyConverter.twoDecimalPlaceFixedWithoutRounding(controller.miningTrackList[index].minReturnPerDay ?? ""),
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: Dimensions.space5),
                            DefaultText(text: controller.miningTrackList[index].period.toString(), textColor: MyColor.colorBlack)
                          ],
                        ),
                      ),
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: Dimensions.space5),
                            DefaultText(text: controller.miningTrackList[index].periodRemain.toString(), textColor: MyColor.colorBlack)
                          ],
                        ),
                      )
                    ],
                  ...
                  controller.miningTrackList[index].status == "0" ? Column(
                    children: [
                  ...
                  ) : controller.miningTrackList[index].status == "1" ? const SizedBox(height: Dimensions.space20)
                      : controller.miningTrackList[index].status == "2" ? const SizedBox(height: Dimensions.space20)
                      : controller.miningTrackList[index].status == "3" ? const SizedBox(height: Dimensions.space20) : const SizedBox(height: Dimensions.space20)
                ],
              ),
            ),
          ),
